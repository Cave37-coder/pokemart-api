...
SET_ID_MAP = {
    ...
    'TR': 'base5', 'G1': 'gym1', 'G2': 'gym2', 'N1': 'neo1', 'N2': 'neo2',
    'N3': 'neo3', 'N4': 'neo4', 'LC': 'base6', 'SI1': 'si1', 'PR-WB': 'basep',
    'EX': 'ecard1', 'AQ': 'ecard2', 'SK': 'ecard3', 'RS': 'ex1', 'SS': 'ex2',
    'DR': 'ex3', 'MA': 'ex4', 'HL': 'ex5', 'RG': 'ex6', 'TRR': 'ex7',
    'DX': 'ex8', 'EM': 'ex9', 'UF': 'ex10', 'DS': 'ex11', 'LM': 'ex12',
    'HP': 'ex13', 'CG': 'ex14', 'DF': 'ex15', 'PK': 'ex16',
    'DP': 'dp1', 'MT': 'dp2', 'SW': 'dp3', 'GE': 'dp4', 'MD': 'dp5',
    'LA': 'dp6', 'SF': 'dp7', 'PL': 'pl1', 'RR': 'pl2', 'SV': 'pl3',
    'AR': 'pl4', 'HS': 'hgss1', 'UL': 'hgss2', 'UD': 'hgss3', 'TM': 'hgss4',
    'CoL': 'col1', 'CL': 'col1', 'PR-HS': 'hsp', 'PR-DP': 'dpp', 'PR-DPP': 'dpp',
    'BLW': 'bw1', 'EPO': 'bw2', 'NVI': 'bw3', 'NXD': 'bw4', 'DEX': 'bw5',
    'DRX': 'bw6', 'DRV': 'dv1', 'BCR': 'bw7', 'PLS': 'bw8', 'PLF': 'bw9',
    'PLB': 'bw10', 'LTR': 'bw11', 'LTRRC': 'bw11', 'PR-BLW': 'bwp',
    'MCD11': 'mcd11', 'MCD12': 'mcd12',
    'KSS': 'xy0', 'XY': 'xy1', 'FLF': 'xy2', 'FFI': 'xy3', 'PHF': 'xy4',
    'PRC': 'xy5', 'DCR': 'dc1', 'ROS': 'xy6', 'AOR': 'xy7', 'BKT': 'xy8',
    'BKP': 'xy9', 'GEN': 'g1', 'GENRC': 'g1', 'FCO': 'xy10', 'STS': 'xy11',
    'EVO': 'xy12', 'PR-XY': 'xyp', 'MCD14': 'mcd14', 'MCD15': 'mcd15', 'MCD16': 'mcd16',
    'SUM': 'sm1', 'GRI': 'sm2', 'BUS': 'sm3', 'SLG': 'sm35', 'CIN': 'sm4',
    'UPR': 'sm5', 'FLI': 'sm6', 'CES': 'sm7', 'DRM': 'sm75', 'LOT': 'sm8',
    'TEU': 'sm9', 'DET': 'det1', 'UNB': 'sm10', 'UNM': 'sm11', 'HIF': 'sm115',
    'HIFSV': 'sma', 'CEC': 'sm12', 'PR-SM': 'smp',
    'MCD17': 'mcd17', 'MCD18': 'mcd18', 'MCD19': 'mcd19',
    'SWSH01': 'swsh1', 'SWSH02': 'swsh2', 'SWSH03': 'swsh3', 'CPA': 'swsh35',
    'SWSH04': 'swsh4', 'SHF': 'swsh45', 'SHFSV': 'swsh45sv', 'BST': 'swsh5',
    'MCD21': 'mcd21', 'SWSH06': 'swsh6', 'SWSH07': 'swsh7', 'CLB': 'cel25',
    'CCC': 'cel25c', 'SWSH08': 'swsh8', 'SWSH09': 'swsh9', 'SWSH10': 'swsh10',
    'PGO': 'pgo', 'ASRTG': 'swsh10tg', 'SWSH11': 'swsh11', 'LORTG': 'swsh11tg',
    'SWSH12': 'swsh12', 'ST': 'swsh12tg', 'CRZ': 'swsh12pt5', 'CRZGG': 'swsh12pt5gg',
    'TOT22': 'poptb', 'MCD22': 'mcd22', 'PR-SWSH': 'swshp',
    'SVP': 'svp', 'SV1': 'sv1', 'PRIZEPACK': 'svp', 'SV2': 'sv2', 'SV3': 'sv3',
    'MEW': 'sv3pt5', 'SV3PT5': 'sv3pt5', 'TOT23': 'poptb', 'SV4': 'sv4',
    'MCD23': 'mcd23', 'PAF': 'sv4pt5', 'SV4PT5': 'sv4pt5', 'TEF': 'sv5',
    'TWM': 'sv6', 'SFA': 'sv6pt5', 'SCR': 'sv7', 'TOT24': 'poptb',
    'SSP': 'sv8', 'PRE': 'sv8pt5', 'JTG': 'sv9', 'MCD24': 'mcd24',
    'DRI': 'sv10', 'BLK': 'zsv10pt5', 'WHT': 'rsv10pt5', 'SVE': 'sve',
...
def enrich_set(set_code, ptcgio_set_id, headers, dry_run=False, stdout=None):
    ...
    for product in db_records:
        ...
        if dry_run:
            log(f"    [DRY] #{card_num} {product.variant_override} {product.name[:25]}")
            updated += 1
            continue
    ...
    # Propagate legality to variants not found in API
    propagated = 0
    ...
    for card in cards_with_legality:
        count = PokemonProduct.objects.filter(
            card_set__code=set_code,
    ...
    if propagated:
        log(f"  Propagated legality to {propagated} variants")

    return updated, not_found


class Command(BaseCommand):
    help = "Enrich existing DB records with pokemontcg.io data"

    def add_arguments(self, parser):
        parser.add_argument("set_code", type=str, help="Set code e.g. ASC or ALL")
    ...
    def handle(self, *args, **options):
        ...
        for code in sets_to_run:
            ...
            try:
                ...
                self.stdout.write(f"  ERROR: {e} — skipping {code}")
