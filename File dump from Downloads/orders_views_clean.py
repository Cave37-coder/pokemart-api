...
def print_order(request, order_id):
    ...
    for set_name, group in groupby(items, key=lambda i: i.product.card_set.name):
        ...
        sets_html += f'''<div style="margin-bottom:12px">
          <h3 style="font-size:13px;background:#f0f0f0;padding:4px 8px;border-left:3px solid #ff6b35;margin-bottom:4px">{set_name} ({len(cards)} card{"s" if len(cards)!=1 else ""})</h3>
