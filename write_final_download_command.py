"""
Run from project root to write the final definitive download_card_images command.

    cd C:\\Users\\texca\\pokemart-api
    python write_final_download_command.py

Filename format:  {SET}-{NUM_PADDED}-{Pokemon-Name}-{Rarity}.png
Examples:
    ...
    MEG-Era/CR-001-Mega-Greninja-ex-Double-Rare.png   (when released)
"""
...
print()
print("Clear old progress and images, then dry run:")
...
print("  WotC/BS-004-Charizard-Holo-Rare.png")
print("  WotC/BS-058-Pikachu-Common.png")
print("  MEG-Era/MEG-001-Venusaur-ex-Double-Rare.png")
print("  MEG-Era/PFL-013-Mega-Charizard-X-ex-Double-Rare.png")
print("  MEG-Era/ASC-001-Ericas-Oddish-Common.png")
print("  MEG-Era/POR-001-Mega-Zygarde-ex-Double-Rare.png")
print("  SV-Era/SCR-001-Venusaur-ex-Double-Rare.png")
print()
print("CR (Chaos Rising) will show [sources: none] until May 22 when pokemontcg.io adds it.")
print("Re-run after May 22: python manage.py download_card_images --set CR")
