...
class OrderAdmin(admin.ModelAdmin):
    list_display = ["id", "user", "status_badge", "total_price", "delivery_method", "waybill_number", "created_at", "print_slip"]
    ...
    fieldsets = [
        ("Order", {"fields": ["user", "status", "total_price", "stripe_payment_intent", "created_at", "updated_at"]}),
        ("Delivery", {"fields": ["delivery_method", "delivery_address_line1", "delivery_address_line2", "delivery_city", "delivery_province", "delivery_postal_code"]}),
